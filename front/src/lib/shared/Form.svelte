	...
	{#if submittable}
		<div class="w-full flex justify-between mt-4">
			...
			<button
				...
				class="bg-green-700 {isSendButtonDisabled ? 'cursor-not-allowed' : 'hover:bg-green-800'} transition-all duration-300 py-1.5 px-3 rounded-xl text-2xl font-bold flex justify-center items-center gap-3"
			>
					{#if isLoading}
