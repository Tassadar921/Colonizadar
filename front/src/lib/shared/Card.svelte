...
<Link {href} on:mouseenter={() => (hovering = true)} on:mouseleave={() => (hovering = false)} className="flex flex-col md:flex-row items-center p-6 rounded-lg shadow-lg bg-gray-300 dark:bg-gray-700 h-40">
