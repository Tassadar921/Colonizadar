...
<Modal bind:showModal={showJoinModal}>
	...
	<Form action="/api/room/join" method="POST" hasBackground={false} bind:isValid={isJoinSubmittable} on:success={handleJoinSuccess} on:error={handleJoinFailure}>
...
<Modal bind:showModal={showCreateModal}>
	...
	<Form action="/api/room/create" method="POST" hasBackground={false} bind:isValid={isCreateSubmittable} on:success={handleCreateSuccess} on:error={handleCreateFailure}>
