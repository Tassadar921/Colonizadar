    ...
    async run(): Promise<void> {
        ...
        const territories: { code: string; french: string; english: string; isCoastal: boolean; map: Map; defaultBelongsTo?: PlayableCountry; isFactory?: boolean; power?: number; ships?: number }[] =
            [
                ...
                { code: 'FL', french: 'Floride', english: 'Florida', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, isFactory: true, power: 110000, ships: 5 },
                { code: 'TX', french: 'Texas', english: 'Texas', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, isFactory: true, power: 25000, ships: 55 },
                { code: 'CA', french: 'Californie', english: 'California', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, power: 65000, ships: 15 },
                { code: 'DA', french: 'Dakota', english: 'Dakota', isCoastal: false, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, power: 55000 },
                ...
                { code: 'SN', french: 'Écosse', english: 'Scotland', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.gb, isFactory: true, power: 60000, ships: 85 },
                { code: 'IL', french: 'Irlande', english: 'Ireland', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.gb, isFactory: true, power: 120000, ships: 30 },
                { code: 'GB', french: 'Grande-Bretagne', english: 'Great Britain', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.gb, power: 45000, ships: 10 },
                { code: 'NF', french: 'Nord de la France', english: 'Northern France', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.fr, power: 110000, ships: 15 },
                {
                    code: 'MF',
                ...
                { code: 'RH', french: 'Rhénanie', english: 'Rhine', isCoastal: false, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.de, isFactory: true, power: 110000 },
                { code: 'SX', french: 'Saxe', english: 'Saxony', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.de, isFactory: true, power: 120000, ships: 10 },
                { code: 'PS', french: 'Prusse', english: 'Prussia', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.de, power: 65000, ships: 5 },
                ...
                { code: 'UR', french: 'Oural', english: 'Ural', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.ru, power: 170000, ships: 15 },
                // ********** Africa **********
                ...
                { code: 'CS', french: 'Sibérie centrale', english: 'Central Siberia', isCoastal: false, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.ru, power: 70000 },
                { code: 'SI', french: 'Sibérie orientale', english: 'Eastern Siberia', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.ru, power: 75000, ships: 35 },
                ...
                { code: 'HK', french: 'Hokkaido', english: 'Hokkaido', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.jp, power: 130000, ships: 5 },
                { code: 'HS', french: 'Honshu', english: 'Honshu', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.jp, isFactory: true, power: 100000, ships: 50 },
                { code: 'KU', french: 'Kyushu', english: 'Kyushu', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.jp, isFactory: true, power: 70000, ships: 40 },
                // ********** Oceania **********
