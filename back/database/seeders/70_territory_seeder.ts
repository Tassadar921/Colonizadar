...
export default class extends BaseSeeder {
    async run(): Promise<void> {
        ...
        const territories: { code: string; french: string; english: string; isCoastal: boolean; map: Map; defaultBelongsTo?: PlayableCountry; isFactory?: boolean; infantry?: number; ships?: number }[] =
            [
                // ********** North America **********
                ...
                { code: 'FL', french: 'Floride', english: 'Florida', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, isFactory: true, infantry: 110000, ships: 5 },
                { code: 'TX', french: 'Texas', english: 'Texas', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, isFactory: true, infantry: 25000, ships: 55 },
                { code: 'CA', french: 'Californie', english: 'California', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, infantry: 65000, ships: 15 },
                { code: 'DA', french: 'Dakota', english: 'Dakota', isCoastal: false, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.us, infantry: 55000 },
                ...
                { code: 'IL', french: 'Irlande', english: 'Ireland', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.gb, isFactory: true, infantry: 120000, ships: 30 },
                { code: 'GB', french: 'Grande-Bretagne', english: 'Great Britain', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.gb, infantry: 45000, ships: 10 },
                { code: 'NF', french: 'Nord de la France', english: 'Northern France', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.fr, infantry: 110000, ships: 15 },
                {
                    code: 'MF',
                    french: 'France centrale',
                    english: 'Middle France',
                    isCoastal: true,
                    map: worldMap,
                    defaultBelongsTo: worldMapPlayableCountries.fr,
                    isFactory: true,
                    infantry: 110000,
                    ships: 55,
                },
                ...
                { code: 'RH', french: 'Rhénanie', english: 'Rhine', isCoastal: false, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.de, isFactory: true, infantry: 110000 },
                { code: 'SX', french: 'Saxe', english: 'Saxony', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.de, isFactory: true, infantry: 120000, ships: 10 },
                { code: 'PS', french: 'Prusse', english: 'Prussia', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.de, infantry: 65000, ships: 5 },
                ...
                { code: 'UR', french: 'Oural', english: 'Ural', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.ru, infantry: 170000, ships: 15 },
                // ********** Africa **********
                ...
                {
                    code: 'SW',
                    french: 'Sibérie occidentale',
                    english: 'Western Siberia',
                    isCoastal: true,
                    map: worldMap,
                    defaultBelongsTo: worldMapPlayableCountries.ru,
                    isFactory: true,
                    infantry: 150000,
                    ships: 25,
                },
                { code: 'CS', french: 'Sibérie centrale', english: 'Central Siberia', isCoastal: false, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.ru, infantry: 70000 },
                { code: 'SI', french: 'Sibérie orientale', english: 'Eastern Siberia', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.ru, infantry: 75000, ships: 35 },
                ...
                { code: 'HK', french: 'Hokkaido', english: 'Hokkaido', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.jp, infantry: 130000, ships: 5 },
                { code: 'HS', french: 'Honshu', english: 'Honshu', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.jp, isFactory: true, infantry: 100000, ships: 50 },
                { code: 'KU', french: 'Kyushu', english: 'Kyushu', isCoastal: true, map: worldMap, defaultBelongsTo: worldMapPlayableCountries.jp, isFactory: true, infantry: 70000, ships: 40 },
                // ********** Oceania **********
        ...
        for (const territory of territories) {
            if (!(await territoryRepository.findOneBy({ code: territory.code, mapId: territory.map.id }))) {
                await Territory.create({
                    ...
                    defaultInfantry: territory.infantry,
